...
export default function SyaratMendaftar() {
  ...
  return (
    <div className="flex container mt-0 md:my-24 md:mt-0  text-center md:text-left flex-col-reverse lg:flex-row  justify-between lg:items-start items-center mb-28 ">
      {/* <!-- == img header ==--> */}
      ...
      {/* <!-- == text header ==--> */}
      <div className="lg:pl-20 space-y-3 md:space-y-6 md:pt-12 lg:pt-0 h-full lg:flex lg:flex-col lg:items-start lg:justify-end lg:border-r-0 text-left" data-aos="fade-right">
        ...
        <p className=" leading-relaxed lg:text-lg  lg:w-[70%]">
