    ...
    <section className="container hidden md:block mb-20 mt-40">
      <div data-aos="zoom-in" className="py-12 w-full bg-primary rounded-3xl md:rounded-2xl lg:rounded-3xl flex items-center justify-center text-center flex-col">
        <div className="flex flex-col justify-center text-center mx-auto md:w-[90%]  space-y-3 items-center ">
          {/* <!-- == text header ==--> */}
          <h4 className="text-white font-bold lg:text-4xl md:text-3xl text-2xl "> {`"Satu Langkah Menuju Prestasi, Bersama Gelora Nusantara!"`}</h4>
          <p className=" leading-relaxed lg:text-lg text-sm  lg:w-[70%] text-white">Kami berkomitmen untuk memberikan pengalaman belajar yang bermakna dan membantu Anda mencapai potensi terbaik dalam menggapai masa depan yang cerah.</p>
